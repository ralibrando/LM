...
##Create a list to keep devices in
allDevices = []
...
while done==0:
	##Request Info
	httpVerb ='GET'
	resourcePath = '/device/groups/148/devices'

	## Get list of devices ID's in group 
	queryParams ='?fields=id,displayName,system.sysinfo,autoProperties&filter=system.sysinfo~IOS'
	#queryParams = ""
	data = ''
